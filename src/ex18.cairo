...
mod Ex18 {
    ...
    ////////////////////////////////
    use starknet_cairo_101::utils::ex18_base::Ex18Base::distribute_points;
    use starknet_cairo_101::utils::ex18_base::Ex18Base::validate_exercise;
    use starknet_cairo_101::utils::ex18_base::Ex18Base::ex_initializer;
    use starknet_cairo_101::utils::ex18_base::Ex18Base::validate_answers;
    use starknet_cairo_101::utils::ex18_base::Ex18Base::secret_value_internal;
