...
mod Ex15 {
    ...
    ////////////////////////////////
    use starknet_cairo_101::utils::ex15_base::Ex15Base::distribute_points;
    use starknet_cairo_101::utils::ex15_base::Ex15Base::validate_exercise;
    use starknet_cairo_101::utils::ex15_base::Ex15Base::ex_initializer;
    use starknet_cairo_101::utils::ex15_base::Ex15Base::validate_answers;
    use starknet_cairo_101::utils::ex15_base::Ex15Base::secret_value_internal;
