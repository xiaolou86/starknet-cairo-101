...
mod Ex16 {
    ...
    ////////////////////////////////
    use starknet_cairo_101::utils::ex16_base::Ex16Base::distribute_points;
    use starknet_cairo_101::utils::ex16_base::Ex16Base::validate_exercise;
    use starknet_cairo_101::utils::ex16_base::Ex16Base::ex_initializer;
    use starknet_cairo_101::utils::ex16_base::Ex16Base::validate_answers;
    use starknet_cairo_101::utils::ex16_base::Ex16Base::secret_value_internal;
